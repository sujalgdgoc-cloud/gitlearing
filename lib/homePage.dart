...
class Homepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    GridTile(child: Container(padding: EdgeInsets.symmetric(vertical: 2), child: Image.network("https://media.istockphoto.com/id/998309062/photo/burger-with-beef-and-cheese.jpg?s=2048x2048&w=is&k=20&c=WiewZ2pC0tP1-NfjpxTkWYXVCBotqrIzWXc2HkAewkk=")

    ),
      footer: Text("Cheese-Burger ₹450", style: GoogleFonts.aboreto(fontSize: 15,fontWeight: FontWeight.bold),),
    ),
    GridTile(child: Container( padding: EdgeInsets.all(2), child: Image.network("https://media.istockphoto.com/id/187248625/photo/pepperoni-pizza.jpg?s=2048x2048&w=is&k=20&c=KWdxgdyv_fRDh8i8D5LToxbKpcRrNJ0iVCmQZ8LFoAY="),),
    footer: Text("Pizza ₹330", style: GoogleFonts.aboreto(fontSize: 15,fontWeight: FontWeight.bold),),),
    GridTile(child: Container(padding: EdgeInsets.all(2), child: Image.network("https://media.istockphoto.com/id/1166678093/photo/spaghetti-with-tomato-sauce-shot-on-rustic-wooden-table.jpg?s=2048x2048&w=is&k=20&c=6N8WtPXSqRt4_vx9EfpzrfjsDxHhwdfHyTzchmMUj_w="),),
    footer: Text("Pasta ₹500", style: GoogleFonts.aboreto(fontSize: 15,fontWeight: FontWeight.bold),)),
    GridTile(child: Container(padding: EdgeInsets.all(2), child: Image.network("https://media.istockphoto.com/id/966934632/photo/appetizing-french-fries-in-a-bowl.jpg?s=2048x2048&w=is&k=20&c=dMUdvvI2aE0F5nkG12yb6jMTryWFaE7sWkS04JkXlAo="),),
